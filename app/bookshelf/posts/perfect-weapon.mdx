...
I also suspect cyber warfare is a huge blind spot for many people. It shouldn't be - it's not some vague threat, it's something that has _already_ had a significant impact on the U.S., such as the hack of the DNC during the 2016 election.
